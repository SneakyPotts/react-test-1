...
function OffersSection() {
  return (
    <div className={styles.offersSection}>
      <Title className={styles.offersTitle}>
        <span className={styles.offersTitleAccent}>3D</span>
        -печать
      </Title>
      <div className={styles.container}>
        <p className={styles.offersDescription}>
          Предлагаем услуги 3D-печати для производства прототипов или готовых
          изделий любой формы, цвета и прочности. Готовы производить как
          единичные экземпляры, так и целые партии для мелких и больших
          производств.
        </p>
        <div className={styles.containerRightSide}>
          ...
          <p>
            Благодаря высокой точности проработки и качеству материалов можем
            быть полезны для целого ряда отраслей: промышленных стартапов,
            автомобильного производства, сферы архитектуры и медицины, сувениров
